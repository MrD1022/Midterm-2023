...
## Unify designatedArea (to match housing units data set)
...
fema_v2_20 <- fema_v2_20 %>% 
  left_join(haus_uni_20, by = c("designatedArea"= "County"))
## In 2021 FEMA v2, there are counties with reused names in several states.
...
fema_v2_21$StFull <- state_dict[fema_v2_21$state]
fema_v2_21 <- fema_v2_21 %>% 
  left_join(haus_uni_21, by = c("designatedArea"= "County"))
